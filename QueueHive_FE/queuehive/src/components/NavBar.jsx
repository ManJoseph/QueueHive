...
import { FaHome, FaUser, FaBuilding, FaChartBar, FaCogs, FaSignOutAlt, FaSignInAlt, FaUserPlus, FaBell } from 'react-icons/fa';
...
const NavBar = () => {
  ...
  const getUserNavLinks = () => (
    <>
      ...
      <li><Link to="/user/notifications" className={styles.navLink}><FaBell className={styles.navIcon} /> <span>Notifications</span></Link></li>
  ...
  const getCompanyAdminNavLinks = () => (
    <>
      ...
      <li><Link to="/company/queue-management" className={styles.navLink}><FaUser className={styles.navIcon} /> <span>Queue</span></Link></li>
